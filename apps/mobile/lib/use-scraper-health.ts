...
export const SCRAPER_SOURCES: SourceConfig[] = [
  ...
  },
  {
    ...
    description: 'Per-card mention counts across target subreddits · 4-hourly',
  ...
  },
  {
    ...
    description: 'Trending Now sigmoid recompute · hourly',
  ...
  },
  {
    ...
    description: 'Partitions + 30d baselines + snapshot cleanup',
